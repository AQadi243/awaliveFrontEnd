    ...
    <div className="md:w-1/3 relative text-sm" >
      ...
      <div className="p-3 px-3 bg-white shadow">
        ...
        <div className="">
          ...
          <p>
            {bookingInformation.night}-{t("nightStay")}
          </p>
        </div>
      ...
      <div className=" p-3  flex flex-col gap-2 px-3 bg-white shadow  text-sm">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs font-semibold ">
              {currentLanguage === "en"
                ? bookingInformation?.RoomPrice?.toLocaleString()
                : bookingInformation?.RoomPrice?.toLocaleString("ar-EG")}{" "}
              {t("averagePerNight")}{" "}
            </p>
          </div>
          <div>
        ...
        <div className="flex items-center justify-between font-semibold  border-t-2 py-4">
          ...
          <p>
            {currentLanguage === "en"
              ? bookingInformation?.totalWithTax?.toLocaleString()
              : bookingInformation?.totalWithTax?.toLocaleString("ar-EG")}{" "}
            - {t("SAR")}{" "}
          </p>
        </div>
