      ...
      <div className="max-w-4xl mx-auto  text-white">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-[50%] flex flex-col gap-3 px-5 text-center md:text-start ">
            <p className="text-xs  tracking-widest" style={{ fontFamily: "Gilda Display, serif" }}>{t('exploreCity')}</p>
            <h2 className="text-2xl md:text-5xl" style={{ fontFamily: "Gilda Display, serif" }}>{t('primeLocationTitle')}</h2>
