  ...
  return (
    <>
      <section className="md:max-w-7xl mx-auto pt-16 md:py-20 text-[#2E2E2E] px-4">
        <div data-aos="fade-up" className=" flex flex-col lg:flex-row items-center justify-center gap-10">
          <div className="lg:w-[35%] text-center md:text-start">
            ...
            <h3 className="text-2xl md:text-4xl  lg:text-6xl   " style={{ fontFamily: "Gilda Display, serif" }}>
