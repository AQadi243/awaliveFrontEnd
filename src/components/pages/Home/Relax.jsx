  ...
  return (
    ...
    >
      <div className="md:h-full flex flex-col xl:flex-row gap-10 md:gap-14 xl:gap-28 items-center justify-center ">
        ...
        <div
          className="w-full md:w-[60%]  flex flex-col gap-5 md:gap-6  "data-speed="1">
          <div>
            <p className="uppercase text-xs tracking-widest   ">{t('hotelRelaxSubTitle')}</p>
          </div>
          <div className="text-2xl  md:text-4xl xl:text-5xl   tracking-wider flex flex-wrap md:w-[85%]  justify-center text-center md:text-left"style={{ fontFamily: "Gilda Display, serif" }}>
