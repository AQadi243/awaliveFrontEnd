          ...
          <div key={index} className="grid grid-cols-1 md:grid-cols-4  md:gap-3 mb-4">
            ...
            <div className="col-span-3 py-2">
              ...
              <div className="flex flex-row justify-between">
                ...
                <div>
                  <p className="capitalize">
                    {t("total")} :{" "}
                    {currentLanguage === "en"
                      ? booking?.totalWithTax?.toLocaleString()
                      : booking?.totalWithTax?.toLocaleString("ar-EG")}{" "}
                    {t("SAR")}
                  </p>
                  <p>
                    {t("payment")} : {booking.paymentStatus.toLocaleString(currentLanguage)}
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                ...
                <p>
                  {" "}
                  {t("cancelBy")} {getCancellationDate(booking.checkIn)}
                </p>
              </div>
            </div>
          </div>
