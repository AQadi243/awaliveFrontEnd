...
const RoomDetailsBody = ({ singleRoomDetails }) => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col md:flex-row gap-2 justify-between items-center text-center text-sm md:text-lg py-2 md:py-5 px-2">
            {RoomService?.map((service,index) => (
              <div className="flex flex-col gap-2 items-center" key={index}>
                ...
                {/* <img > /> */}
                <p className="text-sm font-medium " style={{ fontFamily: "Gilda Display, serif" }}>{service.name}</p>
              </div>
            ))}
        </div>
      </div>
      ...
      <hr />
      <div className="">
      <h2 className="text-2xl md:text-3xl py-5 md:py-5 " style={{ fontFamily: "Gilda Display, serif" }}>Room Services</h2>
      ...
      {/* Around hotels start */}
      <div className="py-5">
              <h2 className="text-2xl md:text-3xl py-3 md:py-5" style={{ fontFamily: "Gilda Display, serif" }}>Around The Hotel</h2>
              <div className="flex flex-col md:flex-row gap-2 md:gap-3">
                <div className="relative">
                  <img src={arroundImage} alt="" className="" />
                  <p className="absolute bottom-4 left-3 text-white" style={{ fontFamily: "Gilda Display, serif" }}>Coffee Bar</p>
                </div>
                <div className="relative">
                  <img src={arroundImage2} alt="" className="" />
                  <p className="absolute bottom-4 left-3 text-white" style={{ fontFamily: "Gilda Display, serif" }}>Restaurant</p>
                </div>
                <div className="relative">
                  <img src={arroundImage3} alt="" className="" />
                  <p className="absolute bottom-4 left-3 text-white" style={{ fontFamily: "Gilda Display, serif" }}>Wellness</p>
                </div>
              </div>
            </div>
      {/* Around hotels end */}
