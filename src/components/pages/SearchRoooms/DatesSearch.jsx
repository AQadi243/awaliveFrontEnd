...
const DatesSearch = () => {
  ...
  const { night, setNight, checkIn, setCheckIn, checkOut, setCheckOut, setCalender, calender, setGuests, numberOfGuests } =
    authInfo;
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-5  w-full">
            ...
            >
              ...
              <button onClick={handleSelectDate} className="text-md  text-[#BE9874]">
                {checkIn}
              </button>
            </div>
            <div
